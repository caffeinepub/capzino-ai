...
export class Backend implements backendInterface {
    ...
    async createCaptionProject(arg0: string, arg1: string | null, arg2: Array<CaptionSegment>, arg3: string | null, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createCaptionProject(arg0, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg1), arg2, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createRazorpayOrder(arg0: bigint, arg1: string): Promise<string | null> {
        if (this.processError) {
            try {
    ...
    async deleteCaptionProject(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteCaptionProject(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteCaptionProjectWithCooldown(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteCaptionProjectWithCooldown(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateCaptions(arg0: CaptionRequest): Promise<Array<CaptionSegment>> {
        if (this.processError) {
            try {
    ...
    async getLibrary(): Promise<Array<CaptionProject>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLibrary();
    ...
    async getProject(arg0: string): Promise<CaptionProject | null> {
        if (this.processError) {
            try {
    ...
    async getTemporaryProjects(): Promise<Array<TemporalCaptionProject>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTemporaryProjects();
    ...
    async verifyRazorpayPayment(arg0: RazorpayPaymentVerification): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.verifyRazorpayPayment(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_CaptionProject_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CaptionProject): CaptionProject {
    return from_candid_record_n20(_uploadFile, _downloadFile, value);
}
function from_candid_TemporalCaptionProject_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TemporalCaptionProject): TemporalCaptionProject {
...
function from_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_CaptionProject]): CaptionProject | null {
    return value.length === 0 ? null : from_candid_CaptionProject_n19(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        email: value.email,
        isPro: value.isPro,
        proExpiry: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.proExpiry))
    };
}
function from_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    createdAt: _Time;
    language: string;
    captions: Array<_CaptionSegment>;
    videoUrl: [] | [string];
}): {
    title: string;
    thumbnailUrl?: string;
...
function from_candid_record_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        project: from_candid_CaptionProject_n19(_uploadFile, _downloadFile, value.project)
    };
}
...
function from_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CaptionProject>): Array<CaptionProject> {
    return value.map((x)=>from_candid_CaptionProject_n19(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_TemporalCaptionProject>): Array<TemporalCaptionProject> {
    return value.map((x)=>from_candid_TemporalCaptionProject_n23(_uploadFile, _downloadFile, x));
}
...
function to_candid_record_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        email: value.email,
        isPro: value.isPro,
        proExpiry: value.proExpiry ? candid_some(value.proExpiry) : candid_none()
    };
}
